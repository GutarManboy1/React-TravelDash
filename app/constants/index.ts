...
export const user = { name: "Gutar Manboy" };

export const dashboardStats = {
  totalUsers: 16669,
  usersJoined: { currentMonth: 1005, lastMonth: 50 },
  totalTrips: 666,
  tripsCreated: { currentMonth: 6119, lastMonth: 609 },
  userRole: { total: 420, currentMonth: 6119, lastMonth: 609 },
};
